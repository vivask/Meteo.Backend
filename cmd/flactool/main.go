...
func parseArgs() Arguments {
	...
	flag.UintVar(&parallel, "p", 3, "-p num cpu cores, default 3")
...
func searchNeedPkg() (sox, shntool, ffmpeg string, err error) {
...
func main() {
	...
	sox, shntool, ffmpeg, err := searchNeedPkg()
	if err != nil {
		fmt.Println(err)
		os.Exit(1)
	}
	...
	if split {
		err = SplitApeOrFlac(shntool, dir, parallel, remove, verbose)
		if err != nil {
			fmt.Println(err)
			os.Exit(1)
		}
