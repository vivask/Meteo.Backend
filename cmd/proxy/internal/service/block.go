...
func updateList(lists []string) (list *BlackList, loaded []bool) {
...
func UpdateFile(lists []string, dir string) (list *BlackList, loaded []bool) {
...
func LoadFromFile(dir string) *BlackList {
	list := NewBlackList()
