...
func (p esp32API) RegisterProtectedAPIV1(router *gin.RouterGroup) {
	...
	esp32.PUT("/mics6814/calibrate", p.ResetAvr)
	...
	esp32.PUT("/radsens/sens/:val", p.RadsensSetSens)
	esp32.PUT("/ds18b20/temperature", p.Ds18b20TemperatureChk)
	esp32.PUT("/ze08ch2o/ch2o", p.Ze08ch2oChk)

	esp32.GET("/sensors/state", p.GetSensorsState)
	esp32.PUT("/lock/bmx280/:val", p.LockBmx280)
	esp32.PUT("/lock/ds18b20/:val", p.LockDs18b20)
	esp32.PUT("/lock/radsens/:val", p.LockRadsens)
	esp32.PUT("/lock/mics6814/:val", p.LockMics6814)
	esp32.PUT("/lock/ze08/:val", p.LockZe08)
	esp32.PUT("/lock/aht25/:val", p.LockAht25)
}
