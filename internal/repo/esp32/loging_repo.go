...
func (p esp32Service) AddLoging(message, msgType string, time time.Time) error {
	...
	// }
	id, _ := uuid.NewV4()
	logging := entities.Logging{ID: id.String(), Message: message, Type: msgType, CreatedAt: time}
